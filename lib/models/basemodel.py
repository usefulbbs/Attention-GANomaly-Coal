...
class BaseModel():
    ...
    def train_one_epoch(self):
        ...
        self.netg.train()
        epoch_iter = 0
        # for step_iter, data in tqdm(enumerate(self.data.train, leave=False, total=len(self.data.train))):

        for step_iter, data in tqdm(enumerate(self.data.train)):
            ...
            self.lossDct[str(self.epoch)+'_'+str(step_iter)]=errors
        ...
        # with open('/media/pikapika/jdddp/skip-ganomaly-master/output/skipganomaly/folder/loss.json','w')as f:
        #     f.write(json.dumps(self.lossDct))
