...
class Options():
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--model', type=str, default='att_det', help='chooses which model to use. ganomaly')
        ...
        self.parser.add_argument('--outf', default='/media/pikapika/jdddp/skip-ganomaly-master/output', help='folder to output images and model checkpoints')
        ...
        self.parser.add_argument('--load_weights',default=False, action='store_true', help='Load the pretrained weights')
        ...
        self.parser.add_argument('--w_con', type=float, default=5, help='Weight for reconstruction loss. default=50')
        self.parser.add_argument('--w_lat', type=float, default=5, help='Weight for latent space loss. default=1')
